...
namespace TF.WIN
{
    public partial class frmInformes : Form
    {
        ...
        {
            // Nombre del recurso que contiene el PDF en los recursos del proyecto
            string nombreRecursoPDF = "ManualdeUsuario"; // Reemplaza "CarpetaIntegradoraAdmProy1.pdf" con el nombre real de tu archivo PDF
        ...
        {
            // Nombre del recurso que contiene el PDF en los recursos del proyecto
            string nombreRecursoPDF = "TesteoSistema"; // Reemplaza "CarpetaIntegradoraAdmProy1.pdf" con el nombre real de tu archivo PDF
        ...
        {
            // Nombre del recurso que contiene el PDF en los recursos del proyecto
            string nombreRecursoPDF = "ProductoSistema"; // Reemplaza "CarpetaIntegradoraAdmProy1.pdf" con el nombre real de tu archivo PDF
