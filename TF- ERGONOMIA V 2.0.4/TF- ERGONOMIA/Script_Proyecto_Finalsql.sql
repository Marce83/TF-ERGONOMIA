...
AS
BEGIN
	SELECT Em.Nombre, Em.Apellido, Em.DNI, Em.Genero, Em.Peso, Em.Altura, Em.FechaNacimiento 'Fecha de Nacimiento', Em.FechaIngreso 'Fecha de Ingreso', Em.Estado, empr.Nombre 'Empresa'
